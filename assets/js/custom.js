...
// Sticky js
var topIMG = 'assets/images/icons/gencode-white.png';
var sclIMG = 'assets/images/icons/gencode.png';

$(window).scroll(function () {
	if ($(this).scrollTop() > 1) {
		$('.header').addClass("sticky");
		$("div .logo a img").attr("src", sclIMG);
	}
	else {
		$('.header').removeClass("sticky");
		$("div .logo a img").attr("src", topIMG);
	}
});
